...
//void I2C_LMI::I2CStartWait()
//{
//  while(digitalRead(SDA) == HIGH){wdt_reset();}
//  while(digitalRead(SCL) == HIGH){wdt_reset();}
//}
//
//void I2C_LMI::I2CStopWait()
//{
//  while(digitalRead(SDA) == HIGH){wdt_reset();}
//  while(digitalRead(SDA) == LOW){wdt_reset();}
//}
